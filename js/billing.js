...
function renderInvoices(page, pageSize) {
  ...
  if (!filtered.length) {
    ...
    renderPagination('billPagination', 0, 1, invPageSize, renderInvoices);
    return;
  }
  ...
  `).join('');
  renderPagination('billPagination', filtered.length, invPage, invPageSize, renderInvoices);
}
